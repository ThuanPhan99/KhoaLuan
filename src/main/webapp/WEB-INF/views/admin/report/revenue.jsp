...
<div class="container-fluid">
    <h1 style="color: forestgreen;">Thông kê doanh thu</h1>
    <div id="sniperReportRevenue" class="sniper" style="display: none; text-align: center;margin-top: 45px;">
        <div class="spinner-border" style="width: 150px;height: 150px;"></div>
    </div>
    <div id="reportRevenue" class="report-order" style="padding: 26px;">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <h2 style="text-align: right; text-align: left; margin-top: 31px;">
                        <a class="text-white btn btn-success" style="width: 125px;" onclick="reportRevenue()">
                            Xuất report</a>
                    </h2>
                </div>
            </div>
